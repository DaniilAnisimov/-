...
# Form implementation generated from reading ui file 'Сategories.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../pictures/catalog.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Категории:"))
